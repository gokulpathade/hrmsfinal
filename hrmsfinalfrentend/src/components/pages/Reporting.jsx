...
// const handleReport = () => {
//   if (!formData.Date || !formData.Reporting || !formData.Reason) {
//     console.error('Please fill in all required fields.');
//     return;
//   }

//   // Check if the user is already signed in (assuming formData.TimeIn is the indicator)
//   if (formData.TimeIn) {
//     // User is already signed in, update the reporting time
//     const body = {
//       ...formData,
//       TimeOut: new Date().toLocaleTimeString(), // Update TimeOut field for sign-out
//     };

//     axios
//       .put(config.serverURL + '/reporting/Reporting/' + formData.R_Id, body)
//       .then((response) => {
...
//       });
//   } else {
//     // User is not signed in, create a new entry with TimeIn
//     const body = {
//       ...formData,
...
//     axios
//       .post(config.serverURL + '/reporting/Reporting/', body)
//       .then((response) => {
//         console.log(response.data);
//         setIsReported(true);
//       })
...
// const handleSignOut = () => {
//   // Show an alert when the user clicks the "Sign Out" button
          ...
          <div>
            {!isReported && (
              <Button
                ...
                onClick={() => {
                  handleReport();
                  // getCurrentDateTime(); // You may add this function if needed
                }}
                disabled={isReported}
              >
                Sign In
